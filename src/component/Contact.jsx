    ...
    return (
        <div className="container contact" id="contact">
           ...
           <div className="contact-info">
            <ul className="ul">
                <li className="li">
                    <a href="https://www.facebook.com/waseem.talib.796/" rel="noopener noreferrer" target="_blank">
                        <span></span>
                        <span></span>
                        <span></span>
                        <span></span>
                ...
                <li className="li">
                    <a href="https://www.instagram.com/talib.waseem/" rel="noopener noreferrer" target="_blank">
                        <span></span>
                        <span></span>
                        <span></span>
                        <span></span>
                ...
                <li className="li">
                    <a href="https://github.com/WaseemTalib" rel="noopener noreferrer" target="_blank">
                        <span></span>
                        <span></span>
                        <span></span>
                        <span></span>
                ...
                <li className="li">
                    <a href="https://twitter.com/waseemtalib14"  rel="noopener noreferrer" target="_blank">
                        <span></span>
                        <span></span>
                        <span></span>
                        <span></span>
